...
public class ExtentReport implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("Find travel insurance plan for students"); // Title of report
		sparkReporter.config().setReportName("Find travel insurance plan for students in PolicyBazaar"); // name of the report
